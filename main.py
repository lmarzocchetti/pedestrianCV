...
def main():
    ...
    parser.add_argument('-n', '--number-of-inference', type=int, default=100, help='Number of inference steps')
    ...
    parser.add_argument('--seed', type=int, default=235296, help='Seed of the stable diffusion generator')
    ...
    if args.mode == 'static':
        ...
        if args.frames == None:
            ...
            mask_frames = masks.create_video_mask(scr_dim, rect_dim, rect_start, args.increment_x, args.increment_y, args.frames)
    ...
    if args.mode == 'static':
        mask_frames = [mask_frames for _ in range(input_frames_all)]
    else:
