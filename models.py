...
class Upsample(nn.Module):
    def __init__(self, scale_factor, mode = 'nearest', *args, **kwargs) -> None:
...
class YOLOLayer(nn.Module):
    def __init__(self, anchors: List[Tuple[int, int]], num_classes: int, new_coords: bool = False, *args, **kwargs) -> None:
        super().__init__(*args, **kwargs)
    ...
    def forward(self, x:torch.Tensor, img_size:int) -> torch.Tensor:
        ...
        x = x.view(batch_size, self.num_anchors, self.no, ny, nx).permute(0, 1, 3, 4, 2).contiguous()
