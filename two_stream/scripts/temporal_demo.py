...
def main():
    ...
    model_path = '../../checkpoints/model_best_flow.pth.tar'
    ...
    temporal_net = models_res.flow_resnet152(pretrained=False, num_classes=101)
    ...
    for line in val_list:
        ...
        clip_path = os.path.join('/work/cvcs_2023_group17/ucf101_frames', line_info[0])
